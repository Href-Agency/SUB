...
# For DDEV users, this should be your project root
...
# For DDEV users, use these commands:
LOCAL_MYSQL_CMD="ddev mysql"
LOCAL_MYSQLDUMP_CMD="ddev mysqldump"
# For non-DDEV setups, use:
